...
class AuctionCreatePage extends GetView<CreateAuctionController>
    with PropertyListingWidgets {
  AuctionCreatePage({Key? key}) : super(key: key);
  static const id = '/AuctionCreatePage';
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: Scaffold(
        appBar: myAppBar(goBack: true, title: 'Create Auction', actions: [
          InkWell(
            onTap: () {
        ...
        body: GetX<CreateAuctionController>(
          initState: (state) {},
          builder: (_) {
            return SafeArea(
              child: Stack(
