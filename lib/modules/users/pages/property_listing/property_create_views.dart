...
class PropertyDetailWidget extends GetView<PropertyCreateController>
    with PropertyListingWidgets {
  const PropertyDetailWidget({Key? key}) : super(key: key);
...
class PropertyLocationPicker extends GetView<PropertyCreateController>
    with PropertyListingWidgets {
  const PropertyLocationPicker({Key? key}) : super(key: key);
        ...
        child: Obx(() {
          return Column(
            ...
            children: [
              ...
              vSpace,
              if (controller.pickedResult.value != null)
                Column(
                  children: [
                    Button(
                      leftPadding: 50.w,
                    ...
                    getTextField(
                        hintText: 'Country',
                        enabled: false,
                        controller: controller.pickedLocationCountryController),
                    vSpace,
                    getTextField(
                        hintText: 'City',
                        enabled: false,
                    ...
                    getTextField(
                        hintText: 'Address',
                        enabled: false,
                        controller: controller.pickedLocationAddressController),
                    vSpace,
                    getTextField(
                        hintText: 'Block',
                        enabled: false,
              ...
              children: [
                ...
                Wrap(
                      ...
                      .map(
                        (e) => InkWell(
                          ...
                          child: getFeatureItem(
                              title: e,
                              color: controller.selectedFeaturesSet.contains(e)
                                  ? AppColor.green
                                  : null),
                        ),
                      )
                  ...
                  InkWell(
                      onTap: () {},
                      child: getFeatureItem(
                          title: 'Electricity', color: AppColor.green)),
                  getFeatureItem(title: 'Electricity'),
                  getFeatureItem(title: 'Electricity'),
                  getFeatureItem(title: 'Electricity'),
                  getFeatureItem(title: 'Electricity'),
                ]*/
            ...
            NestedScrollView(
              ...
              body: Column(
                children: [
                  ...
                  ///submit widgets
                  vSpace,
                  mySwitch(message: 'Agree to terms and conditions'),
                  vSpace,
                  Row(
                    children: [
                      Flexible(
